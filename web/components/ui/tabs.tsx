...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-[linear-gradient(to_bottom_right,_#101010_0%,_#000000_100%)] p-1 text-muted-foreground outline outline-1 outline-white",
      className
    )}
    {...props}
    style={{
